...
## [8.0.0](https://github.com/stevencartavia/revm/compare/revme-v7.2.2...revme-v8.0.0) - 2025-09-13
...
- *(revme)* Avoid panic on non-UTF filenames in statetest runner ([#2948](https://github.com/stevencartavia/revm/pull/2948))

### Other

- Fix CLI exit code for invalid bytecode input ([#2968](https://github.com/stevencartavia/revm/pull/2968))
