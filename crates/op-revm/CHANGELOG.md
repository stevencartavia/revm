...
## [11.0.0](https://github.com/stevencartavia/revm/compare/op-revm-v10.0.0...op-revm-v11.0.0) - 2025-09-13
...
- *(op-revm)* clear enveloped_tx for deposit txs in build_fill and align docs ([#2957](https://github.com/stevencartavia/revm/pull/2957))

### Other

- add SECURITY.md ([#2956](https://github.com/stevencartavia/revm/pull/2956))
- *(op-revm)* rm redundant phantom ([#2943](https://github.com/stevencartavia/revm/pull/2943))
- *(op-revm)* add serialize DepositTransactionParts test ([#2942](https://github.com/stevencartavia/revm/pull/2942))
