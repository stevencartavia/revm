...
## [11.0.0](https://github.com/stevencartavia/revm/compare/revm-handler-v10.0.0...revm-handler-v11.0.0) - 2025-09-13

### Added

- *(revme)* ef blockchain tests cli ([#2935](https://github.com/stevencartavia/revm/pull/2935))

### Fixed

- interpreter_result_mut should return mutable reference ([#2941](https://github.com/stevencartavia/revm/pull/2941))
- FrameStack mark push/end_init as unsafe ([#2929](https://github.com/stevencartavia/revm/pull/2929))

### Other

- Fix infinite recursion in EthPrecompiles PrecompileProvider methods ([#2962](https://github.com/stevencartavia/revm/pull/2962))
- add SECURITY.md ([#2956](https://github.com/stevencartavia/revm/pull/2956))
- update `EthFrame::invalid` visibility ([#2947](https://github.com/stevencartavia/revm/pull/2947))
- remove unused generic from validate_tx_env and fix call site ([#2946](https://github.com/stevencartavia/revm/pull/2946))
- cargo update ([#2930](https://github.com/stevencartavia/revm/pull/2930))
- *(handler)* provide `&CallInputs`to`PrecompileProvider::run` ([#2921](https://github.com/stevencartavia/revm/pull/2921))
