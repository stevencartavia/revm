...
## [7.0.6](https://github.com/stevencartavia/revm/compare/revm-database-v7.0.5...revm-database-v7.0.6) - 2025-09-30
...
- *(database)* extract duplicate test balance constants ([#3017](https://github.com/stevencartavia/revm/pull/3017))
- pretty print state in revme statetest ([#2979](https://github.com/stevencartavia/revm/pull/2979))
- *(database)* avoid panic by conditionally using block_in_place ([#2927](https://github.com/stevencartavia/revm/pull/2927))
