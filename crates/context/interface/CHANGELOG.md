...
## [11.0.0](https://github.com/stevencartavia/revm/compare/revm-context-interface-v10.1.0...revm-context-interface-v11.0.0) - 2025-09-13
...
- *(cleanup)* Remove EIP-7918 related functions and EIP file  ([#2925](https://github.com/stevencartavia/revm/pull/2925))
