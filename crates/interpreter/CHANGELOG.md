...
## [26.0.0](https://github.com/stevencartavia/revm/compare/revm-interpreter-v25.0.2...revm-interpreter-v26.0.0) - 2025-09-13

### Fixed

- skip cold load on oog ([#2903](https://github.com/stevencartavia/revm/pull/2903))

### Other

- add SECURITY.md ([#2956](https://github.com/stevencartavia/revm/pull/2956))
- remove duplicate comment for TOTAL_COST_FLOOR_PER_TOKEN constant ([#2950](https://github.com/stevencartavia/revm/pull/2950))
- clean static_selfdestruct_cost ([#2944](https://github.com/stevencartavia/revm/pull/2944))
- rename SELFDESTRUCT to SELFDESTRUCT_REFUND ([#2937](https://github.com/stevencartavia/revm/pull/2937))
